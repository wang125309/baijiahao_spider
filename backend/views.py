...
def download_total(request):
    ...
    sheet.write(0, 0, 'id')
    sheet.write(0, 1, '百家号更新数量')
    sheet.write(0, 2, '竞品更新数量')
    sheet.write(0, 3, '权重')
    sheet.write(0, 4, '实时同步率')
    sheet.write(0, 5, '类型')
...
def download_excel(request):
    ...
    sheet = xls.add_sheet("data")
    sheet.write(0, 0, 'id')
    sheet.write(0, 1, '百家号用户')
    sheet.write(0, 2, '百家号url')
    sheet.write(0, 3, '百家号发布数量')
    sheet.write(0, 4, '权重')
    sheet.write(0, 5, '竞品发布数量')
    sheet.write(0, 6, '竞品url')
    sheet.write(0, 7, '竞品发布数量')
    sheet.write(0, 8, '同步数')
